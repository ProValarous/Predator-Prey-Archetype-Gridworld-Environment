# src/ppage/baselines/A3C/a3c.py
"""
...
class A3C(BaseAlgorithm):
    ...
    def __init__(self, env, config: dict):
        ...
        # See ppage/baselines/AC/return_normalizer.py and AC's own normalize_returns
...
# ------------------------------------------------------------------
# Standalone CLI -- python -m ppage.baselines.A3C.a3c [--mode train|eval]
