# src/ppage/baselines/AC/actor_critic.py
"""
...
from ppage.baselines.base import BaseAlgorithm
...
from ppage.baselines.AC.return_normalizer import RunningReturnNormalizer
...
# ------------------------------------------------------------------
# Standalone CLI -- python -m ppage.baselines.AC.actor_critic [--mode train|eval]
...
if __name__ == "__main__":
    ...
    from ppage.registry import get_action_space, get_observation_builder
