...
> from three early PRs (now merged). It is kept for provenance under the site's
> Historical Notes section. For current DQN docs see [DQN](algorithms/dqn.md) and
